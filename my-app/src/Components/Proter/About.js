        ...
        <div className="tasks--mainDiv">
                ...
                <div className="flex flex-col gap-8 bg-darkSlateBlue text-2xl text-slate-200 rounded p-4 sm:p-8 md:p-16 w-11/12 sm:w-11/12 md:w-4/5 lg:w-9/10" >
                    ...
                    <div class="bg-sunset1 p-5 mb-5 rounded-lg text-sm">
                        ...
                        <p class="mt-4">Outside the tech world, I've been fortunate to be a part of some great teams and communities. For instance, I contributed in a small way to the Edinburgh University’s Swing Dance Society and have cherished memories with the Scouts, where I was honored with the Duke of Edinburgh awards. These experiences have been pivotal in teaching me the importance of collaboration and understanding.</p>
